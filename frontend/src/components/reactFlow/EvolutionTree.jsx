...
const initialNodes = [
  ...
  },
  {
    ...
    type: "custom",
    data: {
      label: "Sementes Adaptativas I",
      efeito: "aumenta o bônus das Fazendas de +5 → +6 por fazenda.",
      cienciaNecessaria: 5,
      grupo: "agricultura",
      nivel: 2,
    },
  ...
  },
  {
    ...
    type: "custom",
    data: {
      label: "Rotação Agrícola I",
      efeito: "+5% sobre toda a produção das Fazendas",
      cienciaNecessaria: 8,
      grupo: "agricultura",
      nivel: 2,
    },
  ...
  },
  {
    ...
    type: "custom",
    data: {
      label: "Irrigação Eficiente I",
      efeito: "-10% no consumo de energia do Sistema de Irrigação",
      cienciaNecessaria: 8,
      grupo: "agricultura",
      nivel: 2,
    },
...

  {
    ...
    data: {
      label: "Mecanização I",
      efeito: "Cada colono aumenta a produção de comida em +0,5 ",
      cienciaNecessaria: 5,
      grupo: "agricultura",
      nivel: 3,
    },
  ...
  },
  {
    ...
    type: "custom",
    data: {
      label: "Sementes Adaptativas II",
      efeito: "aumenta o bônus das Fazendas de +6 → +7 por fazenda.",
      cienciaNecessaria: 8,
      grupo: "agricultura",
      nivel: 3,
    },
...

  {
    ...
    type: "custom",
    data: {
      label: "Rotação Agrícola II",
      efeito: "+10% sobre toda a produção das Fazendas",
      cienciaNecessaria: 8,
      grupo: "agricultura",
      nivel: 3,
    },
...

  {
    ...
    type: "custom",
    data: {
      label: "Irrigação Eficiente II",
      efeito: "-15% no consumo de energia do Sistema de Irrigação",
      cienciaNecessaria: 8,
      grupo: "agricultura",
      nivel: 3,
    },
...

  {
    ...
    type: "custom",
    data: {
      label: "Mecanização II",
      efeito: "Cada colono aumenta a produção de comida em +1 ",
      cienciaNecessaria: 5,
      grupo: "agricultura",
      nivel: 4,
    },
  ...
  },
  {
    ...
    type: "custom",
    data: {
      label: "Sementes Adaptativas III",
      efeito: "Aumenta o bônus das Fazendas de +7 → +8 por fazenda.",
      cienciaNecessaria: 8,
      grupo: "agricultura",
      nivel: 4,
    },
...

  {
    ...
    type: "custom",
    data: {
      label: "Irrigação de Precisão",
      efeito:
        "Aumenta o bônus do Sistema de Irrigação de +15 → +17 por Sistema de Irrigação.",
      cienciaNecessaria: 8,
      grupo: "agricultura",
      nivel: 4,
    },
  ...
  },
  {
    ...
    type: "custom",
    data: {
      label: "Rações Compactas Táticas",
      efeito: "Exploradores e Marines passam a consumir 1 de comida.",
      cienciaNecessaria: 8,
      grupo: "agricultura",
      nivel: 4,
    },
  ...
  },
  {
    ...
    type: "custom",
    data: {
      label: "Resistência dos Colonos I",
      efeito: "Colonos têm +2 de HP.",
      cienciaNecessaria: 6,
      grupo: "defesa",
      nivel: 2,
    },
  ...
  },
  {
    ...
    type: "custom",
    data: {
      label: "Treinamento de Marines I",
      efeito: "Marines ganham +1 HP e –10% de cooldown",
  ...
  },
  {
    ...
    type: "custom",
    data: {
      label: "Doutrina de Precisão I",
      efeito: "Sniper +1 de alcance e +1 de dano.",
      cienciaNecessaria: 10,
      grupo: "defesa",
      nivel: 2,
    },
...

  {
    ...
    type: "custom",
    data: {
      label: "Muralha Reforçada I",
      efeito: "+20% de HP para a Muralha Reforçada",
      cienciaNecessaria: 10,
      grupo: "defesa",
      nivel: 3,
    },
  ...
  },
  {
    ...
    type: "custom",
    data: {
      label: "Matriz de Gravidade I",
      efeito:
        "Aumenta a força do campo: +10% de lentidão sobre o valor base da Matriz",
      cienciaNecessaria: 6,
      grupo: "defesa",
      nivel: 3,
    },
  ...
  },
  {
    ...
    type: "custom",
    data: {
      label: "Contrafortes Estruturais I",
      efeito: "+1 de Integridade por turno (passivo)",
      cienciaNecessaria: 10,
      grupo: "defesa",
      nivel: 3,
    },
  ...
  },
  {
    ...
    type: "custom",
    data: {
      label: "Logística Hídrica Tática I",
      efeito: "–50% no custo de água para as tropas.",
      cienciaNecessaria: 10,
      grupo: "defesa",
      nivel: 3,
    },
...

  {
    ...
    type: "custom",
    data: {
      label: "Resistência dos Colonos II",
      efeito: "Colonos têm +3 de HP.",
      cienciaNecessaria: 10,
      grupo: "defesa",
      nivel: 4,
    },
  ...
  },
  {
    ...
    type: "custom",
    data: {
      label: "Treinamento de Marines II",
      efeito: "Marines ganham +2 HP e –15% de cooldown",
      cienciaNecessaria: 6,
      grupo: "defesa",
      nivel: 4,
    },
  ...
  },
  {
    ...
    type: "custom",
    data: {
      label: "Muralha Reforçada II",
      efeito: "+30% de HP para a Muralha Reforçada",
      cienciaNecessaria: 10,
      grupo: "defesa",
      nivel: 4,
    },
